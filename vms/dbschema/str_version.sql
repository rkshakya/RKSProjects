...
-- Generation Time: Jun 04, 2008 at 12:31 AM
-- Server version: 5.0.27
-- PHP Version: 5.1.6
-- 
-- Database: `str_version`
-- 
...
CREATE TABLE `vms_compatibility_rules` (
  ...
  `MODIFIED_AT` timestamp NOT NULL default CURRENT_TIMESTAMP COMMENT 'timestamp of rule modified',
  `MODIFIED_BY` int(11) NOT NULL default '0' COMMENT 'user id of modifier',
...
ALTER TABLE `vms_caseserver_mapping`
  ADD CONSTRAINT `im_case_cascade_ibfk_1` FOREIGN KEY (`CASE_GID`) REFERENCES `vms_cases` (`GID`) ON DELETE CASCADE;
