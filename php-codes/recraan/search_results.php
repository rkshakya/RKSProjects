...
$myDisplay = new class_display($myEdit);
	...
	$srchQuery .= " Name LIKE "."'%".$srch."%'"." OR Branch LIKE "."'%".$srch."%' OR Batch LIKE"."'%".$srch."%'" ;
    ...
    <TD height=126>
      <TABLE height=125 cellSpacing=0 cellPadding=0 width=779 border=0>
		...
		document.write("&nbsp;" + time);
                ...
                </TR></FORM></TBODY></FORM></TABLE></TD></TR>
        <TR>
          <TD height=1>
          ...
          <TD vAlign=top width=164 height="365">
            <TABLE cellSpacing=0 cellPadding=0 width=164 
              ...
              <TR>
                ...
                &nbsp;</TD></TR>
              <TR >
                <TD ID = "menuLeft" bgcolor="#C6EFFF" width="164" valign="top" height="140">
...
<TD ID="menuRight" vAlign=top width=615 height="365">
         ...
         <b><font face="Book Antiqua" color="#00247E">Search results for <i><?=$srch?></i></font></b></p>
...
print "<p><table><tr><td ><i>&nbsp;&nbsp;&nbsp;&nbsp;Total [<font color='red'>$count1</font>] Records found.</i></td>";
print "<td>";
 for($i=0; $i<=35; $i++){
	print "&nbsp;";
	}
